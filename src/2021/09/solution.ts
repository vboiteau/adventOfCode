...
const getLowPoints = (heightMap: Array<Array<number>>): Array<Point> =>
  heightMap.reduce(
    (mapLowPoints: Array<Point>, heightMapRow, rowIndex) => [
      ...mapLowPoints,
      ...heightMapRow.reduce((rowLowPoints: Array<Point>, heightMapCell, columnIndex) => {
...
const getBassinForLowPoint = (heightMap: Array<Array<number>>, lowPoint: Point): Array<Point> => {
