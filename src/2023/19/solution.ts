...
export const isCondition = (action: ProcessStep): action is Condition =>
...
export const getProcessMap = (processes: Array<Process>): Record<string, Array<ProcessStep>> =>
  processes.reduce(
    (acc, { id, steps }) => ({
      ...acc,
      [id]: steps,
...
export const isPartApproved = (
  part: PartDescription,
  processes: Record<string, Array<ProcessStep>>,
): boolean => {
