...
const getAlphaNumbersInLine = line => {
  const numbers = line
    .match(
      /1|2|3|4|5|6|7|8|9|oneight|one|twone|two|threeight|three|four|fiveight|five|six|sevenine|seven|eightwo|eighthree|eight|nineight|nine/g,
    )
    .reduce((arr, value) => {
...
const getAlphaNumberForLine = line => {
